<?php
    ...
    // print_r($sql);
    $subtaskName = $_POST["subtask"];
    // if($sql){
        $sql1 = "INSERT INTO tb_subtask(name,taskId) VALUES('$subtaskName','$taskId')";
...
<!-- 
    <li class="flex">
            ...
            <div class="section-content top"> -->
                ...
                <!-- <form action="editSubTask.php" method="POST"> -->
                    <!-- <input type="text" class="edit-view-subtask" style="color:#262626; background: #FAFAFA" value=" echo $subtaskName " name="editSubTask"> -->
                <!-- </form> -->
            <!-- </div>
            ...
            <span class="idSubTask"> echo $subTaskId </span>
    </li> -->