<?php
    ...
    if($status == true)
    {
        ...
        echo 'alert("Tài khoản đã tồn tại. Vui lòng sử dụng tài khoản khác !")';
        echo '</script>'; 
    }
    $status = $_GET['inexactitude'];
    if($status == true)
    {
        echo '<script language = "javascript">';
        echo 'alert("Mật khẩu không trùng nhau. Vui lòng nhập lại !")';
        echo '</script>';  
    }
    $status = $_GET['exist1'];
    if($status == true)
...
<head>
    ...
    <script src="../javascript/jquerylogin.js"></script>
</head>
<body>
    <div class="header">
    ...
    <div class="login-form">
        <form class="loginTab signup" action="ActionSignUp.php" method="POST">
        ...
        <div class="sign-up-link">
            ...
            <a class="signup-link" href="login.php">Sign In</a>
        </div>
    </div>
</body>
</html>
<!-- từ form login trỏ tới trang xulylogin.php để xử lý đăng nhập -> sign out ở class ul11 để trỏ tới logout.php -->