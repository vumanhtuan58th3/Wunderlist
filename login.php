<?php
    ...
    $status = $_GET['loginSuccess'];
    if($status == true)
    {
        echo '<script language = "javascript">';
        echo 'alert("Đăng ký thành công !")';
        echo '</script>'; 
    }
    $status = $_GET['incorrectIDPASS'];
    if($status == true)
    {
        echo '<script language = "javascript">';
        echo 'alert("Sai thông tin tài khoản hoặc mật khẩu. Vui lòng thử lại!!!")';
        echo '</script>'; 
    }
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="login-form">
        <form class="loginTab signin" action="xuly.php" method="POST">
        ...
        <div class="sign-up-link">
            ...
            <a class="signup-link" href="sign-up.php">Create Account</a>
        </div>
    </div>
</body>
</html>
